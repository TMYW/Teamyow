...
//   });
    ...
    // *********************************
    // :: Magnific Popup Active Code - clothing
    // *********************************
    if ($.fn.magnificPopup) {
        $('.clothing-img').magnificPopup({
            type: 'image',
            gallery: {
                enabled: true,
                preload: [0, 2],
     ...
     // *********************************
    // :: 5.0 Masonary Gallery Active Code - clothing
    // *********************************

    if ($.fn.imagesLoaded) {
        $('.alime-clothing').imagesLoaded(function () {
            // filter items on button click
            $('.clothing-menu').on('click', 'button', function () {
                var filterValue = $(this).attr('data-filter');
                $grid.isotope({
                    filter: filterValue
                });
            ...
            // init Isotope
            var $grid = $('.alime-clothing').isotope({
                itemSelector: '.single_gallery_item',
                percentPosition: true,
                masonry: {
                    columnWidth: '.single_gallery_item'
    ...
    $('.clothing-menu button.btn').on('click', function () {
        $('.clothing-menu button.btn').removeClass('active');
        $(this).addClass('active');
    })
    ...
    if ($.fn.owlCarousel) {
        var welcomeSlider = $('.Clothing-slides');
        welcomeSlider.owlCarousel({
            items: 1,
            loop: true,
            autoplay: true,
